...
const TRANSLATIONS = {
  pt: {
    ...
    "hero.cta.secondary": "Explorar colecção",

    "destaque.title": "A nossa selecção",
    "destaque.subtitle": "Perfumes escolhidos a dedo pela nossa equipa",
    "historia.eyebrow": "Sobre nós",
    "historia.title": "A nossa história",
    "historia.text": "Inspirados pela elegância intemporal, por ingredientes raros e pelo luxo contemporâneo, criamos cada fragrância a pensar em quem não se contenta em passar despercebido.",
    "historia.cta": "Saber mais",
    ...
    "contacto.success": "Pergunta enviada. Respondemos para o e-mail que indicou.",
    ...
    "faq.a2": "Preparamos o pedido no prazo de um dia útil depois de confirmarmos o pagamento. O prazo de entrega a seguir a isso depende da localidade e é combinado consigo antes do envio.",
    "faq.amostra.q": "O que é uma amostra?",
    "faq.amostra.a": "É um frasco pequeno do mesmo perfume, pensado para o experimentar antes de comprar o frasco completo. Uma fragrância comporta-se de maneira diferente em cada pele e ao longo do dia, e a amostra permite-lhe conhecê-la com calma. Se depois decidir comprar o frasco completo desse perfume, descontamos o valor que pagou pela amostra: quando o pedido da amostra é entregue, enviamos-lhe um código de desconto do mesmo valor, válido nesse perfume.",
    ...
    "faq.a4": "É como confirmamos que o pagamento entrou. Sem o comprovativo o pedido fica em espera; com ele, conseguimos preparar o envio no mesmo dia.",
    "faq.q5": "Posso trocar ou devolver?",
    "faq.a5": "Pode, até 7 dias seguidos depois de receber, desde que o frasco esteja selado, por usar e na embalagem original. Basta escrever-nos com o número do pedido.",
    "faq.q6": "Como acompanho o meu pedido?",
    "faq.a6": "Na sua conta, em \"Os meus pedidos\", vê tudo o que encomendou e o estado de cada pedido. Também o avisamos pelo contacto que indicou na compra.",
    "faq.q7": "Não sei que perfume escolher. Ajudam?",
    ...
    "contato.field.sobrenome": "Apelido",
    "contato.field.email": "E-mail",
    "contato.field.assunto": "Assunto",
    "contato.field.mensagem": "Mensagem",
    "contato.ph.nome": "O seu nome",
    "contato.ph.sobrenome": "O seu apelido",
    ...
    "contato.info.email": "E-mail",

    "footer.direitos": "Todos os direitos reservados.",
    "footer.tagline": "Feito com carinho para quem gosta de perfumaria.",
    ...
    "checkout.tab.login": "Iniciar sessão",
    ...
    "checkout.name.placeholder": "O seu nome",
    "checkout.phone.placeholder": "O seu contacto",
    ...
    "cart.coupon.placeholder": "Código do cupão",
    ...
    "checkout.done.subtitle": "Obrigado pela sua compra. Vai receber um e-mail assim que confirmarmos o pagamento.",
    ...
    "colecao.title": "A nossa colecção",
    ...
    "sobre.banner.heading": "A Mushy é feita por quem gosta mesmo de perfume",
    "sobre.banner.p1": "Tudo começou como uma paixão simples: testar frasco atrás de frasco até encontrar aquele que parecia feito por medida. Com o tempo, essa curiosidade tornou-se um propósito e hoje reunimos mais de 50 fragrâncias que a própria equipa usaria sem pensar duas vezes, sem rodeios e sem promessas vazias. Apenas bom perfume, a sério, da maneira como gostamos de o usar no dia-a-dia.",
    "sobre.banner.p2": "Cada perfume que chega até si já passou pelo nosso nariz antes de entrar no catálogo. Avaliamos a fixação, a evolução do aroma na pele e aquele algo mais que faz uma fragrância ficar na memória. É esse cuidado, com uma pitada de personalidade, que procuramos em cada frasco que leva o nome Mushy.",
    "sobre.banner.p3": "Mais do que vender perfume, queremos ajudá-la a encontrar a fragrância que combina com a sua história. Por isso, cada sugestão nasce de uma conversa a sério, sem fórmulas prontas e sem pressas. No fim, bom perfume é aquele que se escolhe com carinho, não apenas o que está na prateleira.",
    ...
    "sobre.processo.title": "Cada frasco passa por um crivo antes de chegar até si",
    "sobre.processo.p1": "Testamos, deixamos secar, testamos outra vez no dia seguinte. Avaliamos a fixação, a evolução do aroma na pele e se aquele perfume tem mesmo algo para contar, e não só um cheiro agradável na loja.",
    "sobre.processo.p2": "Trabalhamos directamente com distribuidores de confiança, pelo que cada frasco chega com procedência garantida. Nada de intermediários duvidosos nem promessas vazias: só o que usaríamos no nosso próprio pulso.",
    ...
    "politicas.envio.p1": "Preparamos os pedidos no prazo de um dia útil após a confirmação do pagamento. O prazo de entrega varia consoante a localidade. Dentro de Luanda, o custo de entrega é apresentado no checkout, antes de confirmar o pedido.",
    "politicas.envio.p2": "Recebe actualizações sobre o estado do seu pedido através do contacto que indicou ao finalizar a compra.",
    "politicas.envio.p4": "Entregamos fora de Luanda. Nesse caso o custo é confirmado consigo por contacto directo antes do envio, e o pedido segue normalmente enquanto isso é combinado.",
    "politicas.envio.zones": "Zonas de entrega em Luanda",
    "politicas.envio.zone": "Zona",
    "politicas.envio.cost": "Custo",
    ...
    "review3": "\"Apoio ao cliente impecável e entrega rápida. Já sou cliente fiel.\"",
    "review4": "\"Recebi tantos elogios no primeiro dia que encomendei logo outro frasco.\"",
    ...
    "account.orders.title": "Os seus pedidos",
    "account.orders.empty": "Ainda não fez nenhum pedido.",
    "account.recs.title": "Recomendado para si",
    ...
    "account.referral.empty": "Ainda não se registou nenhum amigo pelo seu link.",
    "referral.used": "Usado",
    "referral.available": "Disponível",
    "referral.copied": "Link copiado!",

    "msg.newsletter.success": "Obrigado! A sua subscrição foi registada.",
    "msg.newsletter.error": "Não foi possível concluir a sua subscrição. Tente novamente.",

    "coupon.not_found": "Cupão não encontrado.",
    "coupon.inactive": "Este cupão já não está activo.",
    "coupon.not_started": "Este cupão ainda não é válido.",
    "coupon.expired": "Este cupão expirou.",
    "coupon.wrong_product": "Este código só pode ser usado no frasco completo do perfume de que experimentou a amostra. Adicione esse frasco ao carrinho para o aplicar.",
    "coupon.campaign_blocks": "O seu carrinho tem produtos na promoção {campaign}, que não pode ser combinada com um cupão. O crédito de uma amostra continua a ser aceite.",
    "coupon.max_uses": "Este cupão atingiu o limite de utilizações.",
    ...
    "auth.badcredentials": "E-mail ou palavra-passe incorrectos.",
    ...
    "checkout.zone.label": "Zona de entrega",
    "checkout.zone.placeholder": "Seleccione a sua zona",
    "checkout.zone.onrequest": "Sob consulta",
    "checkout.zone.note": "Entregamos fora de Luanda. O custo é confirmado consigo por contacto directo antes do envio, e o pedido segue normalmente.",
    "checkout.delivery": "Entrega",
    "checkout.delivery.free": "Grátis",
    "politicas.envio.free": "Entrega grátis em pedidos a partir de {amount}.",
    "cart.delivery.from": "Entrega a partir de {amount} · calculada no checkout",
    "cart.delivery.free": "Entrega grátis neste pedido.",
    "cart.delivery.remaining": "Faltam {amount} para ter entrega grátis.",
  ...
  en: {
    ...
    "faq.amostra.q": "What is an amostra?",
    "faq.amostra.a": "It is a small vial of the same perfume, meant for trying it before buying the full bottle. A fragrance behaves differently on every skin and over the course of a day, and a sample lets you get to know it properly. If you then decide on the full bottle of that perfume, we take the price of the sample off it: when the sample order is delivered we send you a discount code for the same amount, valid on that perfume.",
    ...
    "politicas.envio.p1": "We process orders within 1 business day after payment confirmation. Delivery time varies by location. Within Luanda, the delivery cost is shown at checkout, before you confirm the order.",
    "politicas.envio.p2": "You'll receive updates on your order status through the contact details provided at checkout.",
    "politicas.envio.p4": "We do deliver outside Luanda. In that case the cost is confirmed with you directly before dispatch, and the order proceeds normally in the meantime.",
    "politicas.envio.zones": "Delivery zones in Luanda",
    "politicas.envio.zone": "Zone",
    "politicas.envio.cost": "Cost",
    ...
    "coupon.wrong_product": "This code only works on the full bottle of the perfume you sampled. Add that bottle to your cart to use it.",
    "coupon.campaign_blocks": "Your cart has products in the {campaign} promotion, which cannot be combined with a discount code. An amostra credit is still accepted.",
    ...
    "checkout.zone.label": "Delivery zone",
    "checkout.zone.placeholder": "Select your zone",
    "checkout.zone.onrequest": "On request",
    "checkout.zone.note": "We do deliver outside Luanda. The cost is confirmed with you directly before dispatch, and the order proceeds normally.",
    "checkout.delivery": "Delivery",
    "checkout.delivery.free": "Free",
    "politicas.envio.free": "Free delivery on orders from {amount}.",
    "cart.delivery.from": "Delivery from {amount} · calculated at checkout",
    "cart.delivery.free": "Free delivery on this order.",
    "cart.delivery.remaining": "{amount} more for free delivery.",
